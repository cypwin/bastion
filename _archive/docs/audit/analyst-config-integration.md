...
| File | Path | Role |
|------|------|------|
| Config loader | `/home/cyprian/BASTION/src/bastion/config.py` | YAML search paths, ModelInfo transform |
| All models | `/home/cyprian/BASTION/src/bastion/models.py` | 32 Pydantic models, zero validators |
| Full config | `/home/cyprian/BASTION/config/broker.yaml` | All options, production values |
| Example config | `/home/cyprian/BASTION/config/broker.example.yaml` | Minimal starter, missing 13+ options |
| CLI entry | `/home/cyprian/BASTION/src/bastion/__main__.py` | CLI arg parsing, two-port launch |
| Server factory | `/home/cyprian/BASTION/src/bastion/server.py` | App creation, lifespan, all routes |
| Audit logger | `/home/cyprian/BASTION/src/bastion/audit.py` | Hardcoded /tmp path |
| Watchdog | `/home/cyprian/BASTION/src/bastion/watchdog.py` | sd_notify, ProcessMonitor |
| Client library | `/home/cyprian/BASTION/clients/bastion-client/bastion_client/client.py` | 3 methods, no auth |
| Client models | `/home/cyprian/BASTION/clients/bastion-client/bastion_client/models.py` | 4 models, 1 unused |
| Client tests | `/home/cyprian/BASTION/clients/bastion-client/tests/test_client.py` | 15 tests |
| Server pyproject | `/home/cyprian/BASTION/pyproject.toml` | Version 0.2.0, deps |
| Client pyproject | `/home/cyprian/BASTION/clients/bastion-client/pyproject.toml` | Version 0.1.0, deps |
| systemd service | `/home/cyprian/BASTION/systemd/bastion.service.example` | Type=notify, security hardening |
| Ollama override | `/home/cyprian/BASTION/systemd/ollama-port-override.conf.example` | Port 11435, env vars |
| Power cap | `/home/cyprian/BASTION/systemd/nvidia-powercap.service.example` | GPU power limit |
| Sudoers | `/home/cyprian/BASTION/systemd/bastion-sudoers.example` | Dashboard systemctl |
| Phase 4 plan | `/home/cyprian/BASTION/docs/audit/ref-phase4-polish.md` | Test hardening (not config) |
