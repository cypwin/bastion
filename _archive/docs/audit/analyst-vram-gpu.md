...
**File references**:
- `/home/cyprian/BASTION/src/bastion/health.py` lines 40-71 (nvidia-smi query)
- `/home/cyprian/BASTION/src/bastion/metrics.py` lines 162-170 (defined gauges)
- `/home/cyprian/BASTION/src/bastion/metrics.py` lines 328-348 (unused helper functions)
...
**File reference**: `/home/cyprian/BASTION/src/bastion/models.py` lines 387-414
...
**File reference**: `/home/cyprian/BASTION/src/bastion/watchdog.py` lines 276-325
...
**File reference**: `/home/cyprian/BASTION/src/bastion/vram.py` line 214
...
**File reference**: `/home/cyprian/BASTION/src/bastion/vram.py` lines 113-135, 161-230
...
**File reference**: `/home/cyprian/BASTION/src/bastion/vram.py` lines 309-320
...
**File reference**: `/home/cyprian/BASTION/src/bastion/vram.py` lines 565-589
...
|------|-------|------------------------|
| `/home/cyprian/BASTION/src/bastion/health.py` | 133 | nvidia-smi queries, GPU safety checks |
| `/home/cyprian/BASTION/src/bastion/vram.py` | 616 | VRAM tracking, Ollama fusion, VRAMManager ledger |
| `/home/cyprian/BASTION/src/bastion/models.py` | 528 | GPUStatus, GPUConfig, LoadedModel, ResidencyState |
| `/home/cyprian/BASTION/src/bastion/scheduler.py` | 710 | Eviction logic, swap rate limiter, dispatch |
| `/home/cyprian/BASTION/src/bastion/proxy.py` | 442 | use_mmap injection, num_ctx injection |
| `/home/cyprian/BASTION/src/bastion/watchdog.py` | 326 | GPU lockup detection, health transitions |
| `/home/cyprian/BASTION/src/bastion/metrics.py` | 522 | GPU Prometheus metrics (defined but unused) |
| `/home/cyprian/BASTION/src/bastion/server.py` | 1561 | Status endpoints, VRAM ledger wiring |
| `/home/cyprian/BASTION/config/broker.yaml` | 222 | GPU thresholds, model VRAM sizes, swap rate config |
| `/home/cyprian/BASTION/docs/audit/ref-crash-prevention.md` | 114 | Crash investigation findings and prevention mechanisms |
| `/home/cyprian/BASTION/docs/audit/ref-multi-gpu-plan.md` | 26 | Multi-GPU roadmap |
| `/home/cyprian/BASTION/docs/audit/ref-gpu-patterns.md` | 146 | SWARM_BRAIN GPU pattern extraction history |
