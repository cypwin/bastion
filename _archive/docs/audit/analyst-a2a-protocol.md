...
| File | Path | Relevance |
|------|------|-----------|
| A2A Handler | `/home/cyprian/BASTION/src/bastion/a2a.py` | Core protocol handler (1894 lines) |
| Task Store | `/home/cyprian/BASTION/src/bastion/taskstore.py` | Dual-store with compaction (439 lines) |
| Models | `/home/cyprian/BASTION/src/bastion/models.py` | A2ATaskRecord, ModelLease, Reservation, etc. (528 lines) |
| Server Routes | `/home/cyprian/BASTION/src/bastion/server.py` | A2A route handlers (lines 870-1060) |
| Client Library | `/home/cyprian/BASTION/clients/bastion-client/bastion_client/client.py` | No A2A support (143 lines) |
| Client Models | `/home/cyprian/BASTION/clients/bastion-client/bastion_client/models.py` | No A2A models (47 lines) |
| A2A Tests | `/home/cyprian/BASTION/tests/test_a2a.py` | Task lifecycle, skills, cards, SSE (1154 lines) |
| Lease Tests | `/home/cyprian/BASTION/tests/test_lease.py` | Lease model and handler tests (492 lines) |
| TaskStore Tests | `/home/cyprian/BASTION/tests/test_taskstore.py` | Dual-store, TTL, backpressure (462 lines) |
| A2A Plan | `/home/cyprian/BASTION/docs/audit/ref-a2a-plan.md` | Original implementation plan |
| Phase 3 Protocol | `/home/cyprian/BASTION/docs/audit/ref-phase3-protocol.md` | Phase planning document |
