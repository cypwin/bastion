...
|--------|------|-----|--------------|-------------------|
| `__init__.py` | `/home/cyprian/BASTION/src/bastion/__init__.py` | 14 | N/A | Version mismatch (0.1.0 vs pyproject 0.2.0) |
| `__main__.py` | `/home/cyprian/BASTION/src/bastion/__main__.py` | 175 | NONE | Zero test coverage for CLI entry point |
| `a2a.py` | `/home/cyprian/BASTION/src/bastion/a2a.py` | 1894 | HIGH | Stale docstring ("stub"), dual Reservation+Lease, no cooperative cancellation |
| `audit.py` | `/home/cyprian/BASTION/src/bastion/audit.py` | 340 | HIGH | Hardcoded `/tmp` path, no read API, incomplete event coverage |
| `auth.py` | `/home/cyprian/BASTION/src/bastion/auth.py` | 105 | HIGH | No `hmac.compare_digest()`, no key rotation, no RBAC |
| `circuitbreaker.py` | `/home/cyprian/BASTION/src/bastion/circuitbreaker.py` | 336 | HIGH | Unlimited half-open probes, no scheduler integration |
| `config.py` | `/home/cyprian/BASTION/src/bastion/config.py` | 74 | MEDIUM | No env var overrides, no unknown-key warnings |
| `dashboard.py` | `/home/cyprian/BASTION/src/bastion/dashboard.py` | 2159 | LOW | Fake audit events, hardcoded VRAM budget, no SSE, 6/23 endpoints consumed |
| `health.py` | `/home/cyprian/BASTION/src/bastion/health.py` | 133 | HIGH | Parses only first GPU line, missing nvidia-smi fields |
| `metrics.py` | `/home/cyprian/BASTION/src/bastion/metrics.py` | 522 | MEDIUM | 9/17 metrics never emitted, 8 A2A helpers untested |
| `middleware.py` | `/home/cyprian/BASTION/src/bastion/middleware.py` | 138 | LOW | No RequestID, no error classification, no streaming distinction |
| `models.py` | `/home/cyprian/BASTION/src/bastion/models.py` | 528 | MEDIUM | Zero validation constraints, 12 hidden properties, 3 client drift |
| `proxy.py` | `/home/cyprian/BASTION/src/bastion/proxy.py` | 442 | MEDIUM | No model name validation, proxy TTFT not captured |
| `queue.py` | `/home/cyprian/BASTION/src/bastion/queue.py` | 200 | HIGH | `sweep_stale()` untested, per-request data never exposed |
| `ratelimit.py` | `/home/cyprian/BASTION/src/bastion/ratelimit.py` | 163 | MEDIUM | XFF spoofable, unbounded buckets, not on admin app |
| `scheduler.py` | `/home/cyprian/BASTION/src/bastion/scheduler.py` | 710 | HIGH | Zero Prometheus emissions, cooldown blocks Phase 1, stall diagnosis untested |
| `server.py` | `/home/cyprian/BASTION/src/bastion/server.py` | 1561 | LOW | All route handlers untested, 12 module globals, two-port route duplication |
| `taskstore.py` | `/home/cyprian/BASTION/src/bastion/taskstore.py` | 439 | HIGH | `stats()` never queried, monotonic/wall clock mix, backpressure invisible |
| `telemetry.py` | `/home/cyprian/BASTION/src/bastion/telemetry.py` | 506 | MEDIUM | 3/5 spans never used, `set_inference_tokens()` never called |
| `vram.py` | `/home/cyprian/BASTION/src/bastion/vram.py` | 616 | HIGH | Ledger invisible, journal ephemeral/unrotated, fuzzy model matching fragile |
| `watchdog.py` | `/home/cyprian/BASTION/src/bastion/watchdog.py` | 326 | HIGH | No VRAM monitoring, no memory leak detection, no sd_notify heartbeat |
