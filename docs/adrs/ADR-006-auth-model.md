...
- `src/bastion/server.py` — new `POST /broker/control/restart` endpoint (Call-7 from S121 vision council); admin-auth-gated; auditable; returns `202 Accepted`.
