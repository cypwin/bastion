...
**File**: `/home/user/BASTION/src/bastion/auth.py` (105 lines)
...
**File**: `/home/user/BASTION/src/bastion/ratelimit.py` (163 lines)
...
**File**: `/home/user/BASTION/src/bastion/circuitbreaker.py` (336 lines)
...
**File**: `/home/user/BASTION/src/bastion/watchdog.py` (326 lines)
...
**File**: `/home/user/BASTION/src/bastion/audit.py` (340 lines)
...
|------|------|---------------|
| auth.py | `/home/user/BASTION/src/bastion/auth.py` | API key + bearer token validation |
| ratelimit.py | `/home/user/BASTION/src/bastion/ratelimit.py` | Per-IP token-bucket rate limiting |
| circuitbreaker.py | `/home/user/BASTION/src/bastion/circuitbreaker.py` | Three-state circuit breaker + transport wrapper + bulkhead |
| watchdog.py | `/home/user/BASTION/src/bastion/watchdog.py` | Process monitor + systemd sd_notify |
| audit.py | `/home/user/BASTION/src/bastion/audit.py` | Tiered audit logging with identity hashing |
| server.py | `/home/user/BASTION/src/bastion/server.py` | App factory, route auth, middleware stack |
| a2a.py | `/home/user/BASTION/src/bastion/a2a.py` | A2A protocol, task lifecycle, leases |
| proxy.py | `/home/user/BASTION/src/bastion/proxy.py` | Transparent proxy, request validation |
| models.py | `/home/user/BASTION/src/bastion/models.py` | Config models (AuthConfig, RateLimitConfig, etc.) |
| taskstore.py | `/home/user/BASTION/src/bastion/taskstore.py` | Task store with backpressure and TTL |
| middleware.py | `/home/user/BASTION/src/bastion/middleware.py` | Metrics collection middleware |
| broker.yaml | `/home/user/BASTION/config/broker.yaml` | Default configuration |
| ref-phase2-hardening.md | `/home/user/BASTION/docs/audit/ref-phase2-hardening.md` | Hardening plan (7 deliverables) |
