...
|---|---|---|
| metrics.py | `/home/cyprian/BASTION/src/bastion/metrics.py` | 17 metric definitions, 16 helper functions, no-op stubs |
| telemetry.py | `/home/cyprian/BASTION/src/bastion/telemetry.py` | 5 OTel span types, GenAI conventions, no-op stubs |
| middleware.py | `/home/cyprian/BASTION/src/bastion/middleware.py` | MetricsMiddleware -- only active metric emission site (proxy) |
| models.py | `/home/cyprian/BASTION/src/bastion/models.py` | TelemetryConfig, BrokerConfig with metrics-related models |
| scheduler.py | `/home/cyprian/BASTION/src/bastion/scheduler.py` | Core scheduling loop -- ZERO metric/trace emissions |
| server.py | `/home/cyprian/BASTION/src/bastion/server.py` | App factory, `/broker/metrics` endpoint, ring buffer |
| a2a.py | `/home/cyprian/BASTION/src/bastion/a2a.py` | Only module calling A2A metric + telemetry helpers |
| proxy.py | `/home/cyprian/BASTION/src/bastion/proxy.py` | Proxy pipeline -- no direct metric calls |
| queue.py | `/home/cyprian/BASTION/src/bastion/queue.py` | AffinityQueue -- no metric calls |
| vram.py | `/home/cyprian/BASTION/src/bastion/vram.py` | VRAMManager/Tracker -- 5 gauge-worthy fields unmetricated |
| circuitbreaker.py | `/home/cyprian/BASTION/src/bastion/circuitbreaker.py` | Circuit breaker -- state transitions unmetricated |
| watchdog.py | `/home/cyprian/BASTION/src/bastion/watchdog.py` | ProcessMonitor -- latencies unmetricated |
