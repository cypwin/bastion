...
- Runs go through the Tier-0 wrapper (`quiet-test.sh`), escalating to the test-runner subagent only on verbose failures; the destructive e2e suite stays `BASTION_E2E=1`-gated.
