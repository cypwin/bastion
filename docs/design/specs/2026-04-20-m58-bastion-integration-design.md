...
> **Date:** 2026-04-20
> **Status:** Approved
> **Source:** M58_BASTION_HANDOFF.md (from the-batch-client)
...
the-batch-client M58 introduces smart offloading — routing sub-tasks (summarization,
...
Set by the-batch-client's `OllamaClient` on every outgoing request:
