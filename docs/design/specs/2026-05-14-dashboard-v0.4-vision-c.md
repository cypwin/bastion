...
**Origin:** Dockerized-DSP vision council, 2026-05-14 — 8 lenses × R0/R1/R4. Final recommendation archived at `_archive/sessions/S121/vision-council/round_4_synthesis/FINAL_RECOMMENDATION.md`.
...
This spec codifies the vision council pick: **populate the already-stubbed `/metrics` and `telemetry.py`, ship in-tree Grafana dashboards + a turnkey docker-compose, wire one Alertmanager rule, keep the TUI permanent.**
