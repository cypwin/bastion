...
/home/cyprian/miniforge3/envs/phenotype/bin/python -m bastion
/home/cyprian/miniforge3/envs/phenotype/bin/python -m bastion --config config/broker.yaml
```
...
```bash
/home/cyprian/miniforge3/envs/phenotype/bin/python <script_or_module>
```

**PYTHONPATH** (if needed for imports):
```bash
PYTHONPATH=/home/cyprian/BASTION/src /home/cyprian/miniforge3/envs/phenotype/bin/python -m bastion
```
